...
function HeroSection() {
    return (
        ...
        <div 
            ...
            <p className='pl-16 pt-8'><a href="#" className='text-white font-extrabold text-3xl'><img src={rightarrow} alt="right-arrow" className='inline-block'/> SEE MORE</a></p>

            <p className='pl-16 pt-8'><a href="#" className='text-white font-extrabold text-3xl'><img src={rightarrow} alt="right-arrow" className='inline-block'/> BUY NOW</a></p>
            </div>
        </div>
        </>
    )
