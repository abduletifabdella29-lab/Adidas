...
function Footer() {
    return (
    <>
    <div className=' bg-cover bg-center bg-no-repeat w-full h-98' style={{backgroundColor: '#231F20'}}>
        <div className='flex'>
        ...
        <div>
            <a href="https://github.com/abduletifabdella29-lab">
                <h1 className='text-center font-bold pt-6 pl-5 text-2xl text-white'>Bulit By Abduletif Abdella</h1>
            </a>
        </div>
    </div>
    </>
